...
{:.blog-post-img}
![Keep Calm and Use Enumerator](http://res.cloudinary.com/victorpre/image/upload/c_scale,w_400/v1503849910/blogposts/keep-calm.png)
...
A ~~magia negra~~ explicação muito bem detalhada de como a implementação disso foi possível está muito bem escrita [nesse post](http://patshaughnessy.net/2013/4/3/ruby-2-0-works-hard-so-you-can-be-lazy)
...
[Blocos, Iteradores e Closures em Ruby](http://blogs.iwtraining.com.br/blocos-iteradores-e-closures-em-ruby/)
